        ...
        <div class="col-lg-12 mb-4">
            <div class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Reporte general de cursos</h6>
                </div>
                <div class="card-body">
                    <a href="{{ route('reports.course') }}" class="btn btn-danger btn-block btn-lg col-lg-2" title="PDF">
